...
$yourWebsite = "www.mdyson.net"; // the name of your website
$thanksPage = 'https://mdyson.net/sent.html'; // URL to 'thanks for sending mail' page; leave empty to keep message on the same page 
